...
if len(hepsi_gecici) == 0:
    ...
    for (key, extinf, url, source_name) in hepsi_gecici:
        ...
        # Zaman bilgilerini al veya oluştur
    ...
    with open(birlesik_dosya, "w", encoding="utf-8") as f:
        ...
        # Önce Normal Linkler, Sonra En Alt Linkler
    ...
    print(f"✅ İşlem tamam! Vidmody ve Diziyou linkleri sona taşındı.")def clean_display_name(name):
