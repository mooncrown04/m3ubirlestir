...
# --- URL NORMALİZASYONU (TEKRARI ÖNLEYEN KRİTİK FONKSİYON) ---
def normalize_url(url):
    """Linklerin sonundaki / işaretini ve boşlukları siler, böylece aynı linkler eşleşir."""
    return url.strip().rstrip('/')

# --- İSİM TEMİZLEME VE YIL AYIKLAMA ---
...
def process_metadata(extinf_line, source_name, add_time, year_val, is_new=False, is_duplicate=False):
    ...
    # YEAR TAGI EKLEME (JS Tarafı için önemli)
    if year_val:
    ...
    try:
        ...
        while i < len(lines):
            ...
            if line.startswith("#EXTINF") and i + 1 < len(lines):
                ...
                # URL Normalleştirme ve Tekil Kontrol
